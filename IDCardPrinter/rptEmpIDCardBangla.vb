...
Public Class rptEmpIDCardBangla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDCardPrinter.rptEmpIDCardBangla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpIDCardBangla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpIDCardBangla = New rptEmpIDCardBangla
        rpt.Site = Me.Site
        Return rpt
    End Function
